                ...
                <div class="card">
                    ...
                    <div class="btn-actions-pane-right">
                        <div class="btn-group">
                            ...
                            <a href="{{ $sent_sms_download_url }}"  class="mx-2 btn btn-outline-success">Export as Excel</a>
                            <form action="" method="get" autocomplete="off">
                                <div tabindex="-1" role="menu" aria-hidden="true"
                                    ...
                                    <div class="p-1 text-right">
                                        <a href="{{route('report.sent-sms-log')}}" type="button" class="mr-2 btn btn-outline-alternate">Clear Filters</a>
